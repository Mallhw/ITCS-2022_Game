...
public class Object2 {
    ...
    public Object2(double x, double y, double height, double width, double mass, double damping, double angleInc, Color color) {
        this.x = x;
        this.y = y;
        this.px = x;
        this.py = y;
    ...
    public boolean checkSATGround(Object ground) {
    	// Find the normal vector of each edge
    ...
    public void resolveCollision(Object other) {
    	...
    	if(checkSAT(other)) {
	    	...
	    	if(x < other.getX() - width / 2 && y + height > other.getY()) {
	    		x = x - intersectionX/3;
	    		other.setX(other.getX() + intersectionX/3);
	    	}
	    	...
	    	if(y < other.getY() - height / 2) {
	    		y = y - intersectionY/3;
	    		other.setY(other.getY() + intersectionY/3);
	    	}
	    	if(y > other.getY() + height / 2) {
	    		y = y + intersectionY/3;
	    		other.setY(other.getY() - intersectionY/3);
    ...
    public void draw2(Graphics g) {
        ...
        gg.fillRect(ax, ay, awidth, aheight);
        gg.dispose();
    ...
    public void draw(Graphics g) {
        ...
        g2d.fillRect(ax, ay, awidth, aheight);
    }
    ...
    public void drawLives(int location, Graphics g) {
    	...
    	g.drawString("Lives: " + lives, location, 500);
    }
    ...
    public void applyConstraints2(Object ground) {
    	checkGroundCollison(ground);
    	System.out.println("before yVel: " + yVel);
    	...
    	double pushback = lowestRY - ground.getY();
   ...
   // ********* Player Movement **********
    ...
    public void jumpMechanic(Object ground, double angleInc) {
	...
	public void jumpBool(boolean b) {
